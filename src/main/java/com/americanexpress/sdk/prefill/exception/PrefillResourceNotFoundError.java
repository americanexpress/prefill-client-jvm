...
/**
 * The PrefillResourceNotFoundError class will be raised when the Prefill resource cannot be found
 */
public class PrefillResourceNotFoundError extends PrefillException {
